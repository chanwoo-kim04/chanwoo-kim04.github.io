...
The most direct method is to use the Cayley-Hamilton theorem, which states that a matrix satisfies its own characteristic equation. 
...
4. *Conclusion:*
    We are given the equation $A^5 = aA^2 + bA + cI$. By compairing the coefficients, we find $a = 0$, $b = 9$, and $c = 0$. 
